...
<html lang="en">
<head>
  <title>404 Not Found || Banglabox</title>
  <meta charset="utf-8">
...
<div class="container">
  <div class="notfound-copy">
    ...
    <form method="get" action="{{ route('search') }}">
      <input id="input1" type="text" placeholder="Try Search" name="term">
    </form>
        <!-- Search icon -->
    <!-- <svg class="search-icon" width="26" height="25.8">
      ...
      <p style="margin-top: 20px !important;"><a href="{{ route('home') }}">Home</a></p>
  </div>

  <svg aria-labelledby="Starry sky" alt="Starry sky" class="starry-sky">
    <title id="svgtitle2">Bangla Box</title>
    <!-- STARS START -->
